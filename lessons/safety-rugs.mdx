...
![Rug Pull](https://static.academy.jup.ag/images/lesson/rugpull.png)
...
* **Audit status matters**: Established <Term id="defi">DeFi</Term> protocols publish security audit reports from firms like Zellic, OtterSec, or Certora. No audits is a meaningful red flag.
